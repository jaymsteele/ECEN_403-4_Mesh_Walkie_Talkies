...
GPIO_PinConfig gpioPinConfigs[48] = {
    ...
    /* Owned by CONFIG_I2C_1 as SCL */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_UP_INTERNAL, /* CONFIG_GPIO_I2C_1_SCL */
    /* Owned by CONFIG_I2C_1 as SDA */
    GPIO_CFG_INPUT_INTERNAL | GPIO_CFG_IN_INT_NONE | GPIO_CFG_PULL_UP_INTERNAL, /* CONFIG_GPIO_I2C_1_SDA */
...
const uint_least8_t CONFIG_GPIO_I2C_1_SDA_CONST = CONFIG_GPIO_I2C_1_SDA;
const uint_least8_t CONFIG_GPIO_I2C_1_SCL_CONST = CONFIG_GPIO_I2C_1_SCL;
...
const I2CCC26XX_HWAttrsV1 i2cCC26xxHWAttrs[CONFIG_I2C_COUNT] = {
    /* CONFIG_I2C_1 */
    {
        ...
        .intPriority = (~0),
        .swiPriority = 0,
        .sclPin      = CONFIG_GPIO_I2C_1_SCL,
        .sclPinMux   = IOC_PORT_MCU_I2C_MSSCL,
        .sdaPin      = CONFIG_GPIO_I2C_1_SDA,
...
const uint_least8_t CONFIG_I2C_1_CONST = CONFIG_I2C_1;
